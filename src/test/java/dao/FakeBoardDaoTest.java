...
//
//        List<Piece> pieces = boardDao.findPiecesByGame();
//
...
//    void update_Success() {
//        boardDao.save(A1, new Rook(Color.WHITE));
//        int updatedCount = boardDao.updateByGame(A1, new Knight(Color.BLACK));
//
...
//
//        boardDao.updateByGame(A1, after);
//
...
//        boardDao.save(A2, new Knight(Color.WHITE));
//
//        assertThat(boardDao.deleteByGame()).isEqualTo(2);
//        assertThat(boardDao.findPiecesByGame()).hasSize(0);
//    }
//}
